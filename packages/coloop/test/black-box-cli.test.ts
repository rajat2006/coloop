...
const preloadPath = join(testDirectory, "support", "provider-preload.mjs");
const fakeCodexPath = join(testDirectory, "support", "fake-codex.mjs");
const fakeOpenPath = join(testDirectory, "support", "fake-open.mjs");
